                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    
                              src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782737339/Naivedya_Logo__140623-03-removebg-preview_h7vbu9.png" 
...
Built a professional brand identity and website for Naivaidya Healthcare, creating a trusted digital presence.
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782734623/dees-art-studio_h5bwvv.png" width="200" height="60" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
  Crafted a creative and elegant digital presence for Dee Art Studios, bringing their artistic identity to life online.
</p>
                            </div>
                          </CommonCardBatchAnimated>
                          <CommonCardBatchAnimated
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782735182/logo_xtmabk.svg" width="700" height="169" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
  Developed an intuitive blogging platform for At Sidewalks, creating a seamless reading and storytelling experience.
</p>
                            </div>
                          </CommonCardBatchAnimated>
                        </div>
                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782737754/image-removebg-preview_6_prkllx.png" width="200" height="53" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
  Enhanced Adam Exports' digital presence through social media and website development.
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782740126/WhatsApp_Image_2026-06-29_at_6.52.17_PM-removebg-preview_tpmckc.png" width="665" height="148" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782740616/image-removebg-preview_7_yy4ktk.png" width="200" height="48" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782740795/image-removebg-preview_8_nmpjfi.png" width="200" height="75" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
  Strengthened Vriinc's brand presence through marketing and sub-brand development.
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782740996/image-removebg-preview_9_w5guje.png" width="200" height="49" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
  Strengthened Moosu's digital presence through creative social media campaigns.
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              <Image   alt="Azurio Template Image Example"    src="https://res.cloudinary.com/daoju0r3c/image/upload/v1782741154/image-removebg-preview_10_i2vtig.png" width="200" height="84" />
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
